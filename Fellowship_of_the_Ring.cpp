...
cout << "Only what Bilbo told me" << Period << endl;
cout << "I have heard his story" << Colon << endl;
cout << "how he found it, and how he used it" << Colon << endl;
cout << "on his journey, I mean" << Period << endl;
cout << Apostrophe << "Which story, I wonder" << Comma << Apostrophe << Space << "said Gandalf" << Period << endl;
cout << Apostrophe << "Oh, not what he told the dwarves and put in his book" << Comma << Apostrophe << Space << "said Frodo" << Period << endl;
cout << "He told me the true story soon after I came to live here" << Period << endl;
cout << "He said you had pestered him till he told you, so I had better know too" << Period << endl;
cout << Apostrophe << "No secrets between us, Frodo" << Comma << Apostrophe << endl;
cout << "he said" << Semicolon << endl;
cout << "but they are not to go any further" << Period << endl;
cout << "It's mine anyway" << Period << endl;
cout << Apostrophe << "That's interesting" << Comma << Apostrophe << Space << "said Gandalf" << Period << endl;
cout << Apostrophe << "Well, what did you think of it all" << QuestionMark << Apostrophe << endl;
cout << "If you mean, inventing all that about a" << Space << Apostrophe << "present" << Apostrophe << Comma << Space << "well, I thought the true story much more likely" << Comma << endl;
cout << "and I couldn't see the point of altering it at all" << Period << endl;
cout << "It was very unlike Bilbo to do so, anyway" << Semicolon << endl;
cout << "and I thought it rather odd" << Period << endl;

cout << "So did I" << Period << endl;
cout << "But odd things may happen to people that have such treasures" << Space << Hyphen << Space << "if they use them" << Period << endl;
cout << "Let it be a warning to you to be very careful with it" << Period << endl;
cout << "It may have other powers than just making you vanish when you wish to" << Period << endl;
cout << Apostrophe << "I don't understand" << Comma << Apostrophe << Space << "said Frodo" << Period << endl;
cout << Apostrophe << "Neither do I" << Comma << Apostrophe << Space << "answered the wizard" << Period << endl;
cout << "I have merely begun to wonder about the ring, especially since last night" << Period << endl;
cout << "No need to worry" << Period << endl;
cout << "But if you take my advice you will use it very seldom, or not at all" << Period << endl;
cout << "At least I beg you not to use it in any way that will cause talk or rouse suspicion" << Period << endl;
cout << "I say again" << Colon << endl;
cout << "keep it safe, and keep it secret" << ExclamationMark << endl;
cout << "You are very mysterious" << ExclamationMark << endl;
cout << "What are you afraid of" << QuestionMark << endl;

cout << "I am not certain, so I will say no more" << Period << endl;
cout << "I may be able to tell you something when I come back" << Period << endl;
cout << "I am going off at once" << Colon << endl;
cout << "so this is good-bye for the present" << Period << endl;
cout << "He got up" << Period << endl;

cout << "At once" << ExclamationMark << endl;
cout << "cried Frodo" << Period << endl;
cout << "Why, I thought you were staying on for at least a week" << Period << endl;
cout << "I was looking forward to your help" << Period << endl;
cout << "I did mean to - but I have had to change my mind" << Period << endl;
cout << "I may be away for a good while" << Semicolon << endl;
cout << "but I'll come and see you again, as soon as I can" << Period << endl;
cout << "Expect me when you see me" << ExclamationMark << endl;
cout << "I shall slip in quietly" << Period << endl;

cout << "I shan't often be visiting the Shire openly again" << Period << endl;
cout << "I find that I have become rather unpopular" << Period << endl;
cout << "They say I am a nuisance and a disturber of the peace" << Period << endl;
cout << "Some people are actually accusing me of spiriting Bilbo away, or worse" << Period << endl;
cout << "If you want to know, there is supposed to be a plot between you and me to get hold of his wealth" << Period << endl;
cout << Apostrophe << "Some people" << ExclamationMark << Apostrophe << endl;
cout << "exclaimed Frodo" << Period << endl;
cout << "You mean Otho and Lobelia" << Period << endl;
cout << "How abominable" << ExclamationMark << endl;
cout << "I would give them Bag End and everything else, if I could get Bilbo back and go off tramping in the country with him" << Period << endl;
cout << "I love the Shire" << Period << endl;
cout << "But I begin to wish, somehow, that I had gone too" << Period << endl;
cout << "I wonder if I shall ever see him again" << Period << endl;
cout << Apostrophe << "So do I" << Comma << Apostrophe << Space << "said Gandalf" << Period << endl;
cout << "And I wonder many other things" << Period << endl;
cout << "Good-bye now" << ExclamationMark << endl;
cout << "Take care of yourself" << ExclamationMark << endl;
cout << "Look out for me, especially at unlikely times" << ExclamationMark << endl;
cout << "Good-bye" << ExclamationMark << endl;
cout << "Frodo saw him to the door" << Period << endl;
cout << "He gave a final wave of his hand, and walked off at a surprising pace" << Semicolon << endl;
cout << "but Frodo thought the old wizard looked unusually bent, almost as if he was carrying a great weight" << Period << endl;
cout << "The evening was closing in, and his cloaked figure quickly vanished into the twilight" << Period << endl;
cout << "Frodo did not see him again for a long time" << Period << endl;
...
cout << "The talk did not die down in nine or even ninety-nine days" << Period << endl;
cout << "The second disappearance of Mr. Bilbo Baggins was discussed in Hobbiton, and indeed all over the Shire" << Comma << endl;
cout << "for a year and a day, and was remembered much longer than that" << Period << endl;
cout << "It became a fireside-story for young hobbits" << Semicolon << endl;
cout << "and eventually Mad Baggins, who used to vanish with a bang and a flash and reappear with bags of jewels and gold" << Comma << endl;
cout << "became a favourite character of legend and lived on long after all the true events were forgotten" << Period << endl;
...
cout << Chapter << Space << Three << endl;
cout << "Three is Company" << endl;
...
Indeed, he at once began to carry on Bilbo's reputation for oddity.
He refused to go into mourning;
and the next year he gave a party in honour of Bilbo's hundred-and-twelfth birthday, which he called Hundred-weight Feast.
...
but Frodo kept up the custom of giving Bilbo's Birthday Party year after year until they got used to it.
